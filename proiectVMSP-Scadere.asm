...
.code
    ...
    diferentaVMSP PROC
        ...
        calculareScadere:
            ...
            ;inversam semnul de la al doilea nr pt a efectua scaderea
            not cx
        ...
        interschimbareValori:
            ...
            ;schimbam semnul numarului cu exp mai mic
            xor ax, 8000h
            xor cx, 8000h
        ...
        egalareExponenti:
            ...
            expPrimuluiNrMaiMicSau7:
                ...
                ;aparent este necesar sa negi cele doua numere ca sa functoneze programul (nu stiu dece merge)
                neg ax
                neg bx
            ...
            expPrimuluiNrMaiMareDe7:
                ...
                expAlDoileaNumarMaiMicSau7:
                    ...
                    ;iar trebuie negate numerele, dar nu stiu dece
                    neg ax
                    neg bx
